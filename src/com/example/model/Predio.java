...
public class Predio extends Usuario implements Comparable<Predio> {
	...
	public void setMoradores(List<Morador> moradores) {
		if(moradores == null){
			throw new IllegalArgumentException("Moradores n�o podem ser null.");
		}
	...
	public void setNotificacoes(List<Notificacao> notificacoes) {
		if(notificacoes == null){
			throw new IllegalArgumentException("Notifica��es n�o podem ser null.");
		}
	...
	public void setMedicoes(List<Medicao> medicoes) {
		if(medicoes == null){
			throw new IllegalArgumentException("Medi��es n�o podem ser null.");
		}
