...
public class Endereco {
	...
	public void setEstado(String estado) {
		if (estado == null || estado.trim().isEmpty()) {
			...
			throw new IllegalArgumentException("Estado inv�lido. Coloque apenas a sigla.");
		}
		this.estado = estado;
	}
	...
	public void setCep(String cep) {
		if (cep.length() != TAMANHO_CEP) {
			throw new IllegalArgumentException("Tamanho do CEP � diferente de " + TAMANHO_CEP + " caracteres.");
		}
		this.cep = cep;
	}
	...
	public void setNumero(String numero) {
		if (Integer.parseInt(numero) == 0) {
			throw new IllegalArgumentException("N�mero n�o pode ser 0.");
		}
		this.numero = numero;
	}
}
